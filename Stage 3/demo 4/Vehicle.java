public class Vehicle 
{
	...
	public void setVehicleID(int id) 													// first 3 methods gather values for variables custID, name, and city.
	{
		this.vehicleID = id;
	}
	...
	public int getVehicleID() 																	// next 4 methods allow access to variables custID, name, and city and number of elements in array list .
	{
		return vehicleID;
	}
