        ...
        public void initiateDb(ArrayList<Customer> customers,ArrayList<Vehicle> vehicle,ArrayList<Employee> employees,ArrayList<Payment> payments)
        {
            ...
            while (sc.hasNextLine())
            {
                ...
                if("Empl".equals(line[0]))
                {
                    ...
                    empl.setName(line[1]);
                    empl.setAddress(line[2]);
                    empl.setEthnicity(line[3]);
                    empl.setGender(line[4]);
                    empl.setPhoneNumber(line[5]);
                    empl.setHours(Double.parseDouble(line[6]));
                    empl.setPayRate(Double.parseDouble(line[7]));
                    empl.setInsurance(Boolean.parseBoolean(line[8]));
                    empl.setUntaxedWage();
                    empl.setTaxedWage();
                    employees.add(empl);
                }
                if("Van".equals(line[0])||"Truck".equals(line[0])||"Car".equals(line[0]))
                {
                    if("Van".equals(line[0]))
                    {
                        ...
                        van.setMake(line[11]);
                        van.setYear(Integer.parseInt(line[12]));
                        van.setColor(line[13]);
                        vehicle.add(van);
                    }
                    if("Car".equals(line[0]))
                    {
                        ...
                        car.setMake(line[11]);
                        car.setYear(Integer.parseInt(line[12]));
                        car.setColor(line[13]);
                        vehicle.add(car);
                    }
                    if("Truck".equals(line[0]))
                    {
                        ...
                        trk.setMake(line[11]);
                        trk.setYear(Integer.parseInt(line[12]));
                        trk.setColor(line[13]);
                        vehicle.add(trk);
                    }
                }
